...
VARIANTS=(
  ...
  "rv32imafc_ilp32f"
  "rv32ima_xqci_ilp32"
  "rv32imaf_zve32f_zvfh_zba_zbb_ilp32f"
  "rv32ima_zinx_xqci_ilp32"
  "rv64imac_lp64"
  "rv64gc_lp64d"
  "aarch64a"
  "aarch64a_pacret"
...
VARIANT_BUILD_FLAGS["rv32ima_xqci_ilp32"]="--target=riscv32-unknown-linux-gnu -march=rv32ima_zba_zbb_zbs_zca_zcb_zilsd_zclsd_xqcia_xqciac_xqcibi_xqcibm_xqcicli_xqcicm_xqcics_xqcicsr_xqciint_xqciio_xqcilb_xqcili_xqcilia_xqcilo_xqcilsm_xqcisim_xqcisls_xqcisync_xqccmp_xqccmt0p1 -menable-experimental-extensions -mabi=ilp32"
VARIANT_BUILD_FLAGS["rv32imaf_zve32f_zvfh_zba_zbb_ilp32f"]="--target=riscv32-unknown-linux-gnu -march=rv32imaf_zic64b_zicbom_zicbop_zicboz_ziccamoa_ziccif_ziccrse_zicond_zifencei_zihintntl_zihintpause_zihpm_zimop_za64rs_zawrs_zfa_zfbfmin_zfh_zce_zcmop_zba_zbb_zbs_zkt_zvbb_zve32f_zvl128b_zvfbfmin_zvfbfwma_zvfh_zvkt_smaia_smcsrind_smrnmi_sscofpmf_xsfvfexpa_zvdot4a8i0p1_zicfilp1p0 -menable-experimental-extensions -mabi=ilp32f"
VARIANT_BUILD_FLAGS["rv32ima_zinx_xqci_ilp32"]="--target=riscv32-unknown-linux-gnu -march=rv32ima_zawrs_zacas_zabha_zba_zbb_zbs_zca_zcb_zilsd_zclsd_zdinx_zfinx_zhinx_xqcia_xqciac_xqcibi_xqcibm_xqcicli_xqcicm_xqcics_xqcicsr_xqciint_xqciio_xqcilb_xqcili_xqcilia_xqcilo_xqcilsm_xqcisim_xqcisls_xqcisync_xqccmp_xqccmt0p1 -menable-experimental-extensions -mabi=ilp32"
